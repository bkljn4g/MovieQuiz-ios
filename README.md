...
- Приложение поддерживает устройства iPhone с минимлаьной версией iOS 13, предусмотрен только портретный режим.
- Элементы интерфейса адаптированы под разрешения экранов больших iPhone (13, 13 Pro Max) — верстка под SE и iPad отсутствует.
